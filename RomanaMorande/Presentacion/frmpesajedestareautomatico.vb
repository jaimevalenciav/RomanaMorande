Public Class frmpesajedestareautomatico
    Private dt As New DataTable
    Private Sub btncapturapeso_Click(sender As Object, e As EventArgs) Handles btncapturapesotara.Click
        ...
        End While
    End Sub
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles btncapturapesobruto.Click
        ...
        End While
    End Sub
    Private Sub frmpesajedestareautomatico_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnanula_Click(sender As Object, e As EventArgs) Handles btnanula.Click
        frmclaveautomaticonormal.ShowDialog()
    End Sub
